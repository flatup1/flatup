...
| パス | 理由 |
|---|---|
| `AIKA_personality.md` | 削除扱い。`1_AIKA人格_本番.md` または `00_CORE/` へ移動済みか確認が必要 |
| `FLATUP_mission.md` | 削除扱い。`00_CORE/ブランド理念/` へ移動済みか確認が必要 |
| `SOUL.md` | 削除扱い。`00_CORE/ブランド理念/` へ移動済みか確認が必要 |
