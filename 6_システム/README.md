...
3. 機能棚卸しなら `FLATUPGYM_AI_機能一覧.md`
4. LINE Bot本番仕様なら `LINE_BOT_仕様.md`
5. 開発・本番反映なら `開発フロー.md`
6. AIKA人格なら `1_AIKA人格_本番.md`
7. JINの思考整理・作業再開なら `JIN_COPILOT_OS.md` と `03_SKILLS_INTERNAL/jin_copilot_protocol.md`
8. `5_アーカイブ/` 内の資料
