...
3. `6_システム/FLATUPGYM_AI_中学生向け説明書.md`
4. `6_システム/FLATUPGYM_AI_機能一覧.md`
5. `6_システム/FLATUPGYM_AI_整理台帳.md`
...
- `6_システム/FLATUPGYM_AI_中学生向け説明書.md`: FLATUPGYM AIの全体像を簡単な言葉で説明する入門書。
- `6_システム/FLATUPGYM_AI_整理台帳.md`: 未整理ファイルを安全に分類するための台帳。移動・削除はJIN承認後。
